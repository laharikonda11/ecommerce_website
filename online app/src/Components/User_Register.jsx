            ...
            <div className="row section-t3">
              <div className="col-sm-12">
                <div className="title-box-d">
                  <h3 className="title-d">User Register Form</h3>
                </div>
              </div>
            </div>
            <div className="row">
                ...
                <div className="property-contact">
                  <form className="form-a" onSubmit={handleSubmit} encType="multipart/form-data">
                      ...
                      <div className="col-md-6 mb-1">
                        <div className="form-group">
                          <input type="text" onChange={e => setContact(e.target.value)} name='contact' className="form-control form-control-lg form-control-a" id="inputEmail1" placeholder="Contact *" required />
                        </div>
                      </div>
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-12 mt-3 mb-2 text-center">
                        <button type="submit" className="btn btn-a">Sign Up</button>
                      </div>
                  </form>
                </div>
              </div>
