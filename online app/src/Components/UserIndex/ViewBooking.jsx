              ...
              <div className="card">
                <div className="card-body">
                  ...
                  <table className="table" style={{ marginTop: '10px' }}>
                    <thead>
                      <tr>
                        <th style={{ fontSize: '15px', backgroundColor: '#D2B4DE', color: 'black' }}>Sr. No</th>
                        <th style={{ fontSize: '15px', backgroundColor: '#D2B4DE', color: 'black' }}>Booking Id</th>
                        <th style={{ fontSize: '15px', backgroundColor: '#D2B4DE', color: 'black' }}>Booking Date</th>
                        <th style={{ fontSize: '15px', backgroundColor: '#D2B4DE', color: 'black' }}>Status</th>
                        <th style={{ fontSize: '15px', backgroundColor: '#D2B4DE', color: 'black' }}>Quantity</th>
                        <th style={{ fontSize: '15px', backgroundColor: '#D2B4DE', color: 'black' }}>Total Price</th>
                        <th style={{ fontSize: '15px', backgroundColor: 'D2B4DE', color: 'black' }}>Product Details</th>
                        <th style={{ fontSize: '15px', backgroundColor: 'D2B4DE', color: 'black' }}>Cancel Booking</th>
                      </tr>
                    </thead>
                    <tbody>
