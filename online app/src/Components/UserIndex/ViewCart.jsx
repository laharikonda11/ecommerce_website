  ...
  return (
    <div>
      <div className="col-md-11 grid-margin stretch-card" style={{marginLeft:"50px", marginTop:"132px"}}>
          <div className="card">
            <div style={{ backgroundColor: "#7FB3D5 ", height: "40px" }}>
              <h4
                style={{ marginLeft: "25px", marginTop: "10px", color: "#7F8C8D" }}
              ...
              <div style={{marginTop:"30px", marginBottom:"30px"}}>
                <Link className="btn btn-primary" style={{marginLeft:"200px",color:'white', background:'#E6B0AA', marginRight :'350px'}} to="/userIndex/ViewProduct1"><i className='fa fa-tags'></i> Continue Shopping</Link>
                <Link className="btn btn-primary" style={{marginLeft:"200x",color:'white' , background:'#E6B0AA'}} to={`/userIndex/checkout/${cartData._id}`}><i className='fa fa-credit-card'></i> Buy Now</Link>
                <button className="btn btn-success" style={{borderColor:"#7F8C8D",marginLeft:"440px", width:"220px", marginTop:"10px", color:'white',background:'#AF7AC5 '}}><i className='fa fa-certificate'></i> Total: {totalPrice}</button>
              </div>
            </div>
          </div>
        </div>
