...
import AddToCartButton from './UserIndex/AddToCartButton';
            ...
            <div className="col-lg-8">
              <div className="intro-body">
                <h1 className="intro-title mb-4 ">
                   <br/><span className="color-b"> Flowers and Bouquet</span>
                </h1>
              </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit}>
          <input placeholder="Search" value={product}
                  required
                        ...
                        style={{ width: "250px", height: "40px" }} /><button type="submit" style={{ width: "40px", height: "30px" }}><i className="fa fa-search"></i></button>
        </form>
      </div>
    </div>
  </div>
...
<div className="row">
  <div className="col-md-12">
    <div className="title-wrap d-flex justify-content-between">
      <div className="title-box">
        <h2 className="title-a"><i className="fa fa-desktop"></i> Categories</h2>
      </div>
    </div>
  </div>
</div>
      ...
      {categories.map((category) => (
          <div class="page-content">
            ...
            .map((product) => (
              ...
              <div className="card product-box"> {/* Add product-box class here */}
                <div className="card-body">
                  <div className="d-flex">
                    <div className="text-center" style={{ alignItems: "center" }}>
                      <img
                        style={{ width: "100%", height: "150px", objectFit: "cover" }}
                        src={`http://localhost:8081/images/${product.productimg}`}
                      ...
                      <div className="d-grid">
                        <Link className="btn btn-primary" to="/user_login">Add To Cart</Link>
                      </div>
                    </div>
                  </div>
                </div>
