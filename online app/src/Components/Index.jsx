...
function Index() {
  ...
  <nav className="navbar navbar-default navbar-trans navbar-expand-lg fixed-top" style={{ backgroundColor: "#FAE3C4" }}>
    <div className="container">
      ...
      <Link className="navbar-brand text-brand" to="/"  style={{color:"black"}}>HELLO<span style={{color:"black"}}> SPRING! </span></Link>
        ...
        <div className="col-md-12">
          <div className="copyright-footer">
            <p className="copyright color-text-a">
              &copy; Copyright
              <span className="color-a"> {year} <Link>Hello Spring! </Link></span> All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
