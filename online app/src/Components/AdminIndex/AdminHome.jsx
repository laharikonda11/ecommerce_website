      ...
      <div id="content">
        ...
        <div className="container-fluid">
          <div className="quick-actions_homepage">
            ...
            <li style={{width:"300px", height:"150px", backgroundColor:"white"}}>
                {" "}
                <Link to="/adminIndex/reg_user">
                  {" "}
                  <i className="icon-people" style={{marginTop:"30px"}}></i>  <h5>No.of Customers</h5>{" "}
                </Link>{" "}
                <h4>{userCount}</h4>
              </li>
              <li style={{width:"300px", height:"150px", backgroundColor:"white"}}>
                ...
                <Link to="/adminIndex/adminViewBooking">
                  {" "}
                  <i className="icon-shopping-bag" style={{marginTop:"30px"}}></i>  <h5>No.of Bookings</h5>
                </Link>{" "}
                <h4>{bookingCount}</h4>
              </li>
              <li style={{width:"300px", height:"150px", backgroundColor:"white"}}>
                ...
                <Link to="/adminIndex/view_Product">
                  {" "}
                  <i className="icon-web" style={{marginTop:"30px"}}></i> <h5>No.of Products</h5> {" "}
                </Link>{" "}
                <h4>{productCount}</h4>
              </li>
