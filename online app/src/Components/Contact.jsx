      ...
      <div>
        ...
        <div className="container-fluid">
          <div className="quick-actions_homepage">
            ...
            <li style={{width:"250px", height:"150px", backgroundColor:"#F9CAF4"}}>
                {" "}
                <Link to="#">
                  {" "}
              ...
              <li style={{width:"260px", height:"150px", backgroundColor:"#B7F9FA"}}>
                {" "}
                <Link to="#">
                  {" "}
                  <i className="fa fa-envelope" style={{marginTop:"30px", fontSize:"32px"}}></i>  <h5>Email Id</h5>
                </Link>{" "}
                <h4>hellospring@gmail.com</h4>
              </li>
              <li style={{width:"250px", height:"150px", backgroundColor:"#66FC9E"}}>
                {" "}
                <Link to="#">
                  {" "}
              ...
              <li style={{width:"250px", height:"150px", backgroundColor:"#F7FC66"}}>
                {" "}
                <Link to="#">
                  {" "}
